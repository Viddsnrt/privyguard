...
export default function ScanHistoryPage() {
  ...
  async function loadScans() {
    try {
      ...
      setError(
        "Unable to load scan history. Please make sure the backend is running."
      );
    } finally {
      setLoading(false);
    }
      ...
      <main className="mx-auto max-w-7xl px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 max-w-2xl text-slate-500">
            Review previous privacy scans and
            inspect detected privacy risks.
          </p>
        </div>
          ...
          filteredScans.length === 0 && (
            <div className="flex min-h-[300px] flex-col items-center justify-center rounded-2xl border border-dashed border-slate-300 bg-white px-6 text-center">
              ...
              <p className="mt-2 max-w-md text-sm text-slate-500">
                Your completed privacy scans will
                appear here.
              </p>
            </div>
          )}
            ...
            <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
              ...
              {filteredScans.map((scan) => {
                ...
                return (
                  <div
                    key={scan.id}
                    className="grid gap-4 border-b border-slate-100 px-6 py-5 transition last:border-b-0 hover:bg-slate-50 md:grid-cols-[2fr_1fr_1fr_1fr_40px] md:items-center"
                  >
